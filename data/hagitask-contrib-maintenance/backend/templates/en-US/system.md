...
Preserve public `$schema` URLs and verify them with the installed HagiTask CLI. Report assumptions, changed files, skipped generated files, validation commands, real exit status, and local destination.
