...
- `@hagicode/hagitask` is the pinned schema source and validator CLI; `test/` contains CLI smoke tests.
...
- Do not copy or edit local schema files or generated publication output.
